...
namespace NWL
{
	enum event_types : ui32 {
		EVT_DEFAULT = 1 << 0,
		EVT_CURSOR_MOVE = 1 << 1, EVT_CURSOR_SCROLL = 1 << 2, EVT_CURSOR_PRESSED = 1 << 3, EVT_CURSOR_RELEASED = 1 << 4, EVT_CURSOR_DOUBLE_CLICK = 1 << 5,
	...
	enum event_categories : ui32 {
		...
		EVC_CURSOR = EVT_CURSOR_MOVE | EVT_CURSOR_SCROLL | EVT_CURSOR_PRESSED | EVT_CURSOR_RELEASED | EVT_CURSOR_DOUBLE_CLICK,
	...
	enum keyboard_codes : ui32 {
		...
		KC_LSHIFT = 16, KC_RSHIFT = 16,
		KC_LCTRL = 17, KC_RCTRL = 18,
		KC_LALT = 19, KC_RALT = 19,
